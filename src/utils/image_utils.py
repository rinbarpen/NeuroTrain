...
class ImageDrawer:
    ...
    def draw_boxes(self, boxes: Sequence[tuple[int, int, int, int]], color: str|Sequence[str] = 'red', thickness: int = 2):
        """
    ...
    def draw_texts(self, texts: Sequence[str], positions: Sequence[tuple[int, int]], color: str|Sequence[str] = 'red', font_scale: float = 1, font_thickness: int = 2):
        """
    ...
    def draw_circles(self, centers: Sequence[tuple[int, int]], radius: int, color: str|Sequence[str] = 'red', thickness: int = 2):
        """
    ...
    def draw_points(self, points: Sequence[tuple[int, int]], color: str|Sequence[str] = 'red', thickness: int = 2):
        """
    ...
    def draw_mask(self, mask: np.ndarray, color: str|tuple[int, int, int] = 'red', alpha: float = 0.5):
        """
    ...
    def draw_masks(self, masks: Sequence[np.ndarray], colors: str|Sequence[str]|tuple[int, int, int]|Sequence[tuple[int, int, int]] = 'red', alpha: float = 0.5) -> Self:
        """
